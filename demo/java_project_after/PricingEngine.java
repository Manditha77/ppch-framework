...
public class PricingEngine {
    ...
    public double calculateFinalPrice(Customer customer, Order order, String couponCode, boolean isHoliday) {
        ...
        if (couponCode != null && !couponCode.isEmpty()) {
            if (couponCode.equals("SAVE10")) {
                ...
                discount = calculateFinalPriceExtracted(customer, discount, order);
    ...
    private double calculateFinalPriceExtracted(Customer customer, double discount, Order order) {
